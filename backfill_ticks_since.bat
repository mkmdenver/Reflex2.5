...
REM ============================================================
REM Reflex2 - Backfill TICKS (ALL symbols) since a date
REM
REM Usage:
REM   backfill_ticks_since YYYY-MM-DD
REM ============================================================
...
if not "%RC%"=="0" (
  echo [ERROR] TICK backfill failed with exit code %RC%
  endlocal & exit /b %RC%
)

echo [DONE] TICK backfill complete.
endlocal
exit /b 0
