...
REM Defaults
if "%MODELVIEW_PORT%"=="" set "MODELVIEW_PORT=7011"

echo.
echo ================== ENV SUMMARY (ModelView) ==================
echo REFLEX_INSTANCE_ID  : %REFLEX_INSTANCE_ID%
echo REDIS               : %GARNET_URL%
echo MODELVIEW_PORT      : %MODELVIEW_PORT%
...
echo Launching ModelView on http://127.0.0.1:%MODELVIEW_PORT%/
echo.

"%ROOT%\.venv\Scripts\python.exe" -m uvicorn "cockpit.modelview.main:app" --host 127.0.0.1 --port %MODELVIEW_PORT%
