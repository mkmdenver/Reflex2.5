...
set TRADER_TRADE_LOG_ENABLE=1
set TRADER_TRADE_LOG_PATH=logs/trades_closed.jsonl
set TRADER_ORDERS_LOG_PATH=logs/orders.log
set TRADER_ORDER_LOG_PATH=logs/orders.log
